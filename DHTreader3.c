...
gcc -shared -I/usr/include/python2.7/ -lpython2.7 -o DHTreader3.so DHTreader3.c -I/usr/local/include -L/usr/local/lib -lwiringPi -lwiringPiDev
...
static PyObject *
DHTreader3_init(PyObject *self, PyObject *args)
{
	return Py_BuildValue("i", wiringPiSetup());
}

static PyObject *
DHTreader3_read(PyObject *self, PyObject *args)
{
	int type, DHTpin;
...
static PyMethodDef DHTReader3Methods[] = {
	{"init", DHTreader3_init, METH_VARARGS,
	 "initialize DHT reader"},
	{"read", DHTreader3_read, METH_VARARGS,
...
initDHTreader3(void)
{
    ...
    m = Py_InitModule("DHTreader3", DHTReader3Methods);
    if (m == NULL)
        return;
}
